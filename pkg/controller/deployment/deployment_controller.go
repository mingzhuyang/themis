...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1alpha1.Deployment{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appv1alpha1.ReplicaSet{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &appv1alpha1.Deployment{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileDeployment) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &appv1alpha1.Deployment{}
...
func newPodForCR(cr *appv1alpha1.Deployment) *corev1.Pod {
