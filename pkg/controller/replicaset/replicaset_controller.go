...
var controllerKind = appv1alpha1.SchemeGroupVersion.WithKind("ReplicaSet")
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1alpha1.ReplicaSet{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &appv1alpha1.ReplicaSet{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileReplicaSet) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &appv1alpha1.ReplicaSet{}
	...
	// Set ReplicaSet instance as the owner and controller
...
func newPodForCR(cr *appv1alpha1.ReplicaSet) *corev1.Pod {
