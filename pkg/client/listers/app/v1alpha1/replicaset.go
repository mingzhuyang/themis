...
type ReplicaSetLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.ReplicaSet, err error)
...
// List lists all ReplicaSets in the indexer.
func (s *replicaSetLister) List(selector labels.Selector) (ret []*v1alpha1.ReplicaSet, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.ReplicaSet))
	})
	return ret, err
}
...
type ReplicaSetNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.ReplicaSet, error)
...
// List lists all ReplicaSets in the indexer for a given namespace.
func (s replicaSetNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.ReplicaSet, err error) {
...
// Get retrieves the ReplicaSet from the indexer for a given namespace and name.
func (s replicaSetNamespaceLister) Get(name string) (*v1alpha1.ReplicaSet, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("replicaset"), name)
	}
	return obj.(*v1alpha1.ReplicaSet), nil
}
