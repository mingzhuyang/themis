...
type DeploymentInterface interface {
	...
	GetScale(deploymentName string, options v1.GetOptions) (*autoscalingv1.Scale, error)
...
func newDeployments(c *AppV1alpha1Client, namespace string) *deployments {
	return &deployments{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *deployments) GetScale(deploymentName string, options v1.GetOptions) (result *autoscalingv1.Scale, err error) {
