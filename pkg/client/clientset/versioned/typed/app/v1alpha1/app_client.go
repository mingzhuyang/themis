...
import (
	...
	"github.com/mingzhuyang/themis/pkg/client/clientset/versioned/scheme"
...
// AppV1alpha1Client is used to interact with features provided by the app.themis.io group.
type AppV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AppV1alpha1Client) Deployments(namespace string) DeploymentInterface {
	return newDeployments(c, namespace)
}

func (c *AppV1alpha1Client) ReplicaSets(namespace string) ReplicaSetInterface {
